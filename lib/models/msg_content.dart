...
class MessageContent {
  ...
  bool isImage() {
    ...
    if (dateTime != null && msg != null) {
      String dateTimeString = dateTime!.year.toString() + FixDateUtilities.fixMonthOrDayTo01(dateTime!.month.toString()) + FixDateUtilities.fixMonthOrDayTo01(dateTime!.day.toString());
  ...
  static MessageContent fromJson(Map<String, dynamic> messageMap) {
    try {
      return MessageContent(senderId: messageMap['senderId'], msg: messageMap['msg'], dateTime: DateTime.parse(messageMap['dateTime']));
    } catch (e) {
  ...
  static List<MessageContent> fromJsonList(List<Map<String, dynamic>> messagesMap) {
  ...
  bool operator ==(Object other) =>
      identical(this, other) || other is MessageContent && runtimeType == other.runtimeType && senderId == other.senderId && msg == other.msg && dateTime == other.dateTime;
